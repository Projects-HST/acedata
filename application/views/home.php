<style>.item{margin: 0 0px 30px;}
.fes13-box-icon{left:-10px;}
...
<div id="about" class="page-section" style="padding-bottom:10px;">
    <div class="container-fluid">

        <div class="col-md-4 fes1-img-cont wow fadeInUp">
            <img src="<?php echo base_url(); ?>assets/page/acedataquality.jpg" alt="img">
        </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="fes11-box wow fadeIn">
                                <div class="fes1-box-icon">
                                  <img src="<?php  echo base_url(); ?>assets/images/icons/qp.png" class="img-responsive">
                                </div>
                                <!-- <h3 class="font-montserrat"><strong>Technology</strong></h3> -->
                                <p>The highest quality print, and the best value for money</p>
                            </div>
                        </div>
...
<div class="page-section">
					<div class="container-fluid">
						<div data-equal=".equal-height" class="row row-sm-fix">
							...
							<div class="col-md-6 fes12-img equal-height" style="background-image: url(<?php echo base_url();  ?>assets/page/oure.jpg); height: 571px;">
                <div class="fes2-main-text-cont text-white">
                  ...
                  <div class="fes2-text-cont">Combined with knowledge and experience of over 3 decades, we work meticulously in creating innovative products by delivering competitive pricing, excellent service and highest product standards. </div>
							...
							<div class="col-md-6 fes12-img equal-height" style="background-image: url(<?php echo base_url();  ?>assets/page/ourp.jpg); height: 571px;">
                <div class="fes2-main-text-cont text-white">
                  <div class="fes2-title-45 font-montserrat text-white">
                    <strong>OUR <br>EQUIPMENT</strong>
                  </div>
                  <div class="line-5-100 bg-white"></div>
                  <div class="fes2-text-cont">With over 30 years, our industry-leading machinery can print on any material. Our modernistic equipment provides flexibility that help clients in maximizing their printing needs.</div>
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-4 col-md-4">
                ...
                <div class="fes4-box wow fadeIn" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeIn;">
								  ...
								  <div>
								   Our technology is at the forefront of innovation that utilizes a revolutionary high-density printing, which can generate accurate, expert quality output at dramatic speed.
								  </div>
								</div>
							</div>
              <div class="col-xs-12 col-sm-4 col-md-4">
                <div class="fes4-box wow fadeIn" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeIn;">
								  ...
								  <div>
								   Our solutions benefit businesses, enterprises and industries of all sizes. Discover wide variety of printing products and services that provide the best possible results.
								  </div>
								</div>
							</div>
